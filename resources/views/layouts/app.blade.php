...
<head>
  ...
  <link rel="icon" type="image/jpg" href="{{asset('img/menu.jpg')}}" />
  ...
  <link href="https://fonts.googleapis.com/css2?family=MuseoModerno&family=Poppins:wght@500&display=swap" rel="stylesheet" > 
...
<footer id="footer" class="footer-1">
    ...
    <h5 class="widget-title">
        <div class="d-flex">
            <img src="img/menu.jpg" alt="" width="50" class="rounded-circle">
            <h3 class="font_f mt-2 ml-2 logo">Menu</h3>
        </div>
    </h5>
    ...
    <p>
        <span class="text-danger">
            ...
            Casablanca
        </span>, 20150 AinChock bd. Elkhalil</p>
    <p ><a href="mailto:info@domain.com" class="text-danger" title="glorythemes">info@domain.com</a></p>
